...
# batch_size=4
# for AREA in safety privacy; do
#     echo $AREA
#     areaArray=$AREA[@]
#     for FILE in ${!areaArray}; do
#         echo $FILE
#         DATA_NAME=${FILE%.*}
#         for MODEL in "allenai/tulu-2-7b" "allenai/tulu-2-dpo-7b" "allenai/tulu-2-dpo-13b" "allenai/tulu-2-13b"; do 
#         echo $MODEL
...
#         echo $FILE
#         DATA_NAME=${FILE%.*}
#         for MODEL in "allenai/tulu-2-70b" "allenai/tulu-2-dpo-70b"; do 
#         echo $MODEL
#         # CUDA_VISIBLE_DEVICES=$gpu \
#         python src/unified_infer.py \
#             --engine vllm \
